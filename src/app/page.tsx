      ...
      <div className="min-h-screen bg-[#00001a] text-gray-800">
        <header className="bg-blue-900 text-white py-4">
          ...
          <div className="container mx-auto text-center py-20 px-6">
            ...
            <a href="register" className="bg-blue-500 text-white py-2 px-4 rounded-full hover:bg-gray-700">Get Started</a>
            <a href="login" className="bg-black text-white py-2 px-4 rounded-full hover:bg-gray-700">Resume playing</a>
          </div>
        </header>
